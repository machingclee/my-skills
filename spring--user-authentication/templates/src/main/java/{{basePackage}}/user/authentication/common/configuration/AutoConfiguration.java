...
//region Presentation & Web Boundary Layer Utilities
    ...
    /**
     * Validates Bearer JWTs on {@code @AccessToken} endpoints and stores {@code AccessTokenPayload}
     * on the request for {@link RequestUserArgumentResolver}.
     */
    @Bean
    ...
    /**
     * Resolves {@code @RequestUser AccessTokenPayload} controller parameters from the
     * interceptor's request attribute.
     */
    @Bean
    ...
    /**
     * Registers the access-token interceptor and the {@code @RequestUser} argument resolver.
     */
    @Bean
